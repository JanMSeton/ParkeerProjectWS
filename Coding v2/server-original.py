...
answer_text_mapping = {
    ...
    "Q13": { #A, B, C. Vraag 1 
        'a': """\n-----------------------------\n\nJij vindt :), het blije gezicht, het beste passen bij de schaduw. Misschien denk je wel dat iedereen dat denkt. Je antwoord kan te maken hebben met cultuur: mensen afkomstig uit landen met koudere klimaten associeren schaduw vaker met iets negatiefs. Mensen uit een warmer klimaat antwoorden vaker een blij gezicht, omdat zij schaduw ervaren als verkoelend en dus als positief.\n""",
        'b': """\n-----------------------------\n\nJij vindt :|, het neutrale gezicht, het beste passen bij de schaduw. Misschien ervaar je het soms als positief en soms als negatief, of vond je het een moeilijke vraag. Wist je dat mensen afkomstig uit landen met koudere klimaten schaduw sneller associeren met iets negatiefs en iemand uit een warmer klimaat associeert schaduw sneller met verkoeling en dus als positief.\n""",
        'c': """\n-----------------------------\n\nJij vindt :(, het verdrietige gezicht, het beste passen bij de schaduw. Misschien denk je wel dat iedereen dat denkt. Je antwoord kan te maken hebben met cultuur: mensen afkomstig uit landen met koudere klimaten associeren schaduw vaker met iets negatiefs. Mensen uit een warmer klimaat antwoorden vaker een blij gezicht, omdat zij schaduw ervaren als verkoelend en dus als positief.\n"""
    }
}

dynamic_responses = {  
    "Q14": { #getal. Vraag 2
        "default": """-----------------------------\n\nJij vindt ongeveer {answer} keer per dag iets gek. Als je op reis bent, zal dit waarschijnlijk veel vaker zijn. Op reis ver van huis ervaar je vaak eerst een cultuurshock. Daarna kan je cultuurstress ervaren en dat is een langer proces. Alles is anders dan thuis en je moet je veel aanpassen, dit kan erg vermoeiend zijn. Oefen thuis door eens andere keuzes dan normaal te maken. Bijvoorbeeld naar een andere supermarkt of een andere route fietsen. Kost het meer energie? Misschien. Maar, ben je meer in het moment? Hopelijk wel! Neem dit mee als je nieuwe dingen ervaart en tegenkomt tijdens je project.\n""",        
    },
    "Q15": { #getal. Vraag 3
...
\n-----------------------------\n
Bedankt voor het parkeren van je cultuur. Blijf reflecteren op je cultuur door jouw Bon van Betekenis mee te nemen op project, met anderen te delen en regelmatig door te nemen."""

            # Print the receipt
        try:
            p.text("\n\n") # Print some space before the logo          
...
def print_logo():
        ...
        try:
            # Load the logo
            logo = Image.open("C:\\Users\\Parkeerautomaat\\Documents\\Programs Parkeerautomaat\\Coding v2\\WS-logo-black.bmp")
            p.set(align='center')
            p.image(logo)
